...
/** @brief Attribut berat_badan  menyatakan berapa berat hewan tersebut
  */
  
/** @brief Attribut koordinat  adalah letak dimana hewan berada
  */

/** @brief Attribut makanan adalah keterangan klasifikasi hewan berdasarkan makanan dimana Herbivore=0, Omnivore=1, Carnivore=2
  */
  
/** @brief Attribut land_animal  adalah boolean yang menyatakan dapatkah hewan tinggal di darat
  */

/** @brief Attribut water_animal  adalah boolean yang menyatakan dapatkah hewan tinggal di air
  */

/** @brief Attribut air_animal  adalah boolean yang menyatakan dapatkah hewan tinggal di udara
  */
  
/** @brief Attribut jinak  adalah boolean yang menyatakan jinak atau tidaknya hewan
  */
...
//Tarsiers.h
/** @brief Constructor dari Tarsiers
  * Menghidupkan hewan Tarsiers
  *
  * @param x integer adalah letak absis Tarsiers yang dihidupkan
  * @param y integer adalah letak ordinat Tarsiers yang dihidupkan
  * @param bb integer adalah berat badan Tarsiers yang dihidupkan
  */
...
//Great White Shark.h
/** @brief Constructor dari Great White Shark
  * Menghidupkan hewan Great White Shark
  *
  * @param x integer adalah letak absis Great White Shark yang dihidupkan
  * @param y integer adalah letak ordinat Great White Shark yang dihidupkan
  * @param bb integer adalah berat badan Great White Shark yang dihidupkan
  */
