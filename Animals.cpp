...
//ctor
Animals::Animals(int makan, bool land, bool water, bool air, bool kejinakan, Indices I): makanan(makan), land_animal(land), water_animal(water), air_animal(air), jinak(kejinakan) {
	cout << "\nctor animal " << endl;
	koordinat = I;
